    ...
    >
        ...
        >
            <v-tab 
                ...
                :value="f-1"><span class="font-weight-bold">{{ (f-1).toString().padEnd(3, '0') }}</span>
            </v-tab>
        </v-tabs>
...
const number = ref(Array.from({length: 1000}, (_, index) => index.toString().padStart(3, '0')))
...
onMounted(async () => {
    ...
    await updateLotteryThreeNumber()
})
...
async function updateLotteryThreeNumber() {
    lottoSelected.value = []
